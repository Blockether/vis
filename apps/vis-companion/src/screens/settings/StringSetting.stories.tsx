...
const meta = {
  ...
  args: {
    toggle: { id: "agent_name", label: "Agent name", type: "string", value: "Ada", max_length: 80,
  ...
  render: function AgentName(args) {
    ...
    return <StringSetting key={value} {...args} toggle={{ ...args.toggle, value }}
      onSave={async (next) => { setValue(next.trim()); return true; }} />;
  },
