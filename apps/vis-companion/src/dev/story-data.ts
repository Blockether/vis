...
import activityRepl from '../../../../packages/vis-contract/resources/vis-contract/fixtures/activity-repl.json';
...
export const ACTIVITY_REPL = projection(activityRepl);
...
export const ACTIVITY_ALL_GROUPS = projection({
  ...
  rows: [
    ...
    ['run_tests', 'Ran tests', 'Activity tests', '51 tests passed'],
    ['lint_code', 'Linted code', 'src/components', 'No warnings'],
