...
export function ProviderLimitReset({
  ...
  return (
    <div
      className="space-y-3 border-t border-dialog-edge pt-3 font-mono text-ui text-dialog-foreground"
    ...
    >
      ...
      {notice && (
        <p
          ...
          className={notice.error ? 'text-err-ink' : 'text-dialog-foreground'}
        >
          {notice.text}
        </p>
      )}
