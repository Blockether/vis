...
export function shellHTML({items=[], item=null, search='', error='', detailError=false, siteKey=''}={}) {
  ...
  return `
    ...
    <dialog id="submit-dialog" class="content" aria-labelledby="submit-title">
      ...
      <div class="dialog-body"><p>Share a public GitHub project. We check its files and metadata before you submit it for moderation.</p>
