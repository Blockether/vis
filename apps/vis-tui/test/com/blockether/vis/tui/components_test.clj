(ns com.blockether.vis.tui.components-test
  (:require [com.blockether.vis.tui.interactions :as interactions]
            [com.blockether.vis.tui.components :as comps]
...
(defdescribe overlay-justification-uses-shared-engine-test
             (let [justify-line
                   (deref (ns-resolve 'com.blockether.vis.tui.components 'justify-line))

                   md-rows
                   (deref (ns-resolve 'com.blockether.vis.tui.components 'md-wrapped-rows))]
