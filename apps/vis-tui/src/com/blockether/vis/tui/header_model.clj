(ns com.blockether.vis.tui.header-model
  "Channel-agnostic header layout & content spec.
   ...
   renders the same conceptual header band:
       ...
       [LEFT 30%]   [CENTER 40% session title]   [RIGHT 30%]

   Shared slot ratios, default labels and copy-ID length live here. Channels
   project them onto their medium — TextGraphics cells for Lanterna, and so on.
