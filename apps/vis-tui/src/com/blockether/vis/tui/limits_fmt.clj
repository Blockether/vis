(ns com.blockether.vis.tui.limits-fmt
  "TUI aliases for the channel-neutral limits row formatters.

   The real implementation lives in
   `com.blockether.vis.tui.limits-format` (hoisted from here so
  ...
  (:require [com.blockether.vis.tui.limits-format :as limits-format]))
