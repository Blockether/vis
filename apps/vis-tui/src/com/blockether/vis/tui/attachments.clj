(ns com.blockether.vis.tui.attachments
...
(defn- video-verdict
  "The send verdict for a CLIP, which no vision wire accepts in any container.
   ...
   ([[com.blockether.vis.tui.image-convert/video->wire-gif]]) -- a format
         ...
         (cond
           ...
           (update acc
                   ...
                   {:path label
                    ...
                    ;; ([[com.blockether.vis.tui.audio-transcribe]]). The manifest
                    ...
                    ;; `unavailable`, `silent`
                    ;; ([[com.blockether.vis.tui.audio-transcribe/statuses]]).
