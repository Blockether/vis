...
passes 2000 immediate-termination attempts on both systems; the full macOS runtime suite
passes 171 cases. Full Linux runtime and consumer verification is in progress before a new
runtime release and consumer pin. The first Linux runtime check used a copied interpreter
cache with generated bytecode; its distribution check needs a clean staged interpreter.
