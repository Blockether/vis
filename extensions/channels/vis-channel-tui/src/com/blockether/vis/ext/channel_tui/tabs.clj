...
(defn- place-key
  ...
  []
  (let [dir  (.getCanonicalPath (io/file (System/getProperty "user.dir")))
        base (-> (.getName (io/file dir))
               (str/replace #"[^A-Za-z0-9._-]+" "_"))
        base (if (str/blank? base) "root" base)
        h    (Long/toUnsignedString (Integer/toUnsignedLong (hash dir)) 36)]
    (str base "-" h)))

(defn- tabs-file ^java.io.File []
