...
in-app under ⚙, or scan a pairing QR generated by `vis gateway start --host 0.0.0.0 --require-token --pair`. For off-LAN use, scan a QR whose URL is the machine's Tailscale `100.x` address. `npm run typecheck` runs TypeScript 7 strict
