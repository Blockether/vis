(ns com.blockether.vis.ext.common-environment.render
...
(defn render
  "Build the textual `<environment>` block from a snapshot map of
   the shape:
     ...
     {:host       <com.blockether.vis.ext.common-environment.host/snapshot>
      :git        <com.blockether.vis.ext.common-environment.git/snapshot or nil>
      :languages  <com.blockether.vis.ext.common-environment.languages/scan>
      :monorepo   <com.blockether.vis.ext.common-environment.monorepo/snapshot or nil>}"
