...
(defdescribe voice-config-test
  ...
  (it "contributes voice-specific doctor diagnostics"
    (with-redefs [voice/model-dir (constantly "/tmp/piper")
                  ...
                  com.blockether.vis.ext.foundation-voice.core/executable? (constantly true)
                  clojure.core/requiring-resolve (fn [sym]
                                                   (case sym
                                                     com.blockether.vis.ext.foundation-voice.asr/transcribe-file! identity
                                                     com.blockether.vis.ext.foundation-voice.core/synthesize-file! identity))]
