(ns com.blockether.vis.ext.language-python.core
  "vis-language-python — a managed Python REPL exposed through the generic
   language facade (repl_start / repl_eval / repl_status / repl_stop). Activates
...
(def vis-extension
  (vis/extension
    {:ext/name           "language-python"
     :ext/description    "Python language pack: a managed Python REPL (uv/poetry/venv/python3) behind the generic repl_start/repl_eval/repl_status/repl_stop facade. Activates on Python workspaces."
     :ext/version        "0.1.0"
