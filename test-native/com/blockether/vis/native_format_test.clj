...
(defdescribe
  ...
  (it
    ...
    (let [^File dir
          (#'native/temp-dir "vis-native-format-")
          ...
          code
          (str "print(format_code('clojure', {'path': 'default.clj'}))\n"
      ...
      (try
        ...
        (with-redefs-fn {#'native/whole-body #(reply false %) #'native/stream-body #(reply true %)}
          (fn []
