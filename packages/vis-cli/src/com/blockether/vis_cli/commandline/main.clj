(ns com.blockether.vis-cli.commandline.main
  "CLI dispatcher entry point.
   ...
   registers itself into `com.blockether.vis-extension.commandline.base`'s global
   ...
   `com.blockether.vis-extension.extension/discover-extensions!`, which finds
  ...
  (:require [clojure.string :as str]
            [com.blockether.vis-cli.logging :as logging]
            [com.blockether.vis-extension.commandline.base :as cmd]
            [com.blockether.vis-extension.extension :as extension]
...
;; doctor, ...) are registered by vis-loop; the `vis channel` and
