(ns com.blockether.vis-runtime.loop.core
...
;; `sdk/register-extensions!`. Forward-declare so the symbol resolves at
...
(defn create-environment
  ...
  (let [depth-atom               (atom 0)
    ...
    (sdk/register-extensions! env register-extension!)
    env))
...
(defn- wrap-extension-with-autobind
  ...
  (let [wrapped             (sdk/wrap-extension extension environment)
