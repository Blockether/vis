(ns com.blockether.vis.commandline.base
...
;;
;;     (ns my.ext.git
;;       (:require [com.blockether.vis.commandline.base :as cmd]))
;;
;;     (cmd/register-global!
;;       {:cmd/name   "git-status"
...
;; ----------------------------------------------------------------------------
;; Extension auto-discovery lives in `com.blockether.vis.extension`.
;;
