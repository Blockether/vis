...
;;   :ext/cli      -> :com.blockether.vis.commandline.base/command
;;   :ext/channels -> :com.blockether.vis.channel/channel
;; All registries now live inside vis-core. The extension facade can
...
;; (`:com.blockether.vis.commandline.base/command`): `:cmd/name` +
...
(s/def :ext/cli
  (s/coll-of :com.blockether.vis.commandline.base/command :kind vector?))
