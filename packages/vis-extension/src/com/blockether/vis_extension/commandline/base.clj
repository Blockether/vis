(ns com.blockether.vis-extension.commandline.base
  "Reusable command-line primitives.
   ...
   `vis-cli/channels.cli` assembles a root command tree mixing
   ...
   of keeping these primitives in their own namespace."
...
;;
;;     (ns my.ext.git
;;       (:require [com.blockether.vis-extension.commandline.base :as cmd]))
;;
;;     (cmd/register-global!
;;       {:cmd/name   "git-status"
...
;; ----------------------------------------------------------------------------
;; Extension auto-discovery lives in `com.blockether.vis-extension.extension`.
;;
;; The single source of truth is
;; `com.blockether.vis-extension.extension/discover-extensions!`, which scans
