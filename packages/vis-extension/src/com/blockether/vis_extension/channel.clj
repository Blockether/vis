(ns com.blockether.vis-extension.channel
  "Channel registry — dynamic, extension-supplied CLI front-ends.
   ...
   Example registration (lives in the channel package, not vis-loop):

     (ns com.blockether.vis.ext.channel-tui.screen
       (:require [com.blockether.vis-extension.channel :as channel]))
   ...
   `com.blockether.vis-extension.extension/discover-extensions!` scans the
...
;; is `com.blockether.vis-extension.extension/discover-extensions!` (in this same
