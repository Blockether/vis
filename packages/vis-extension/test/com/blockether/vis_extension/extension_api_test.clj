(ns com.blockether.vis-extension.extension-api-test
  "Cross-package tests for the extension/runtime contract.
   ...
   facade: see `com.blockether.vis-extension.extension-test`.
   This file only exercises the integration points that need vis-loop
   on the classpath:
  ...
  (:require
   ...
   [com.blockether.vis-loop.core :as vis]
   [com.blockether.vis-extension.extension :as ext]
   [com.blockether.vis-loop.loop.core :as loop-core]
   [com.blockether.vis-loop.loop.runtime.conversation.environment.core :as environment-core]
...
(defdescribe extension-runtime-composition-test
  ...
  (it "vis.core does not re-export the extension contract"
    ;; The extension authoring API lives on `com.blockether.vis-extension.extension`;
    ...
    (expect (not (some #{'extension 'symbol 'value 'register-global!
                   ...
                   (keys (ns-publics 'com.blockether.vis-loop.core)))))))
