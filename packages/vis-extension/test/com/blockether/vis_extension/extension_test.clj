(ns com.blockether.vis-extension.extension-test
  "Pure tests for the extension contract facade.

   Runtime composition tests (`active-extensions`, `assemble-system-prompt`,
   registry interaction) live in `extension_api_test.clj`."
  (:require
