(ns com.blockether.vis-loop.core
  "Public API facade for the Vis RLM (Recursive Language Model).
   ...
   `com.blockether.vis-extension.extension` namespace, which is shipped by
   `com.blockether/vis-loop`. Extensions should require that namespace
   directly."
  (:require
...
;; =============================================================================
;;
;; The CLI entrypoint lives in `com.blockether.vis-cli.commandline.main`
;; (the `:vis` alias / `bin/vis` wrapper). vis-loop is a library
...
;; namespace. They live in `com.blockether.vis-extension.extension` — require that
