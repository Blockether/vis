(ns com.blockether.vis-loop.config
  ...
  (:require [clojure.edn :as edn]
            ...
            [clojure+.error]
            [com.blockether.vis-extension.provider :as provider-registry]
...
(defn resolve-db-spec
  "Resolve DB spec.
   ...
   Returns a db-spec accepted by persistance/create-store-connection."
  ([] (resolve-db-spec nil))
  ([explicit-db-spec]
   (or explicit-db-spec
