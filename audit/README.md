...
| `com.blockether/svar` | `0.7.170` | Apache-2.0 | 619 KB | Blockether (in-house) |
| `com.blockether/tree-sitter-language-pack` | `1.12.3-blockether.39` | MIT | 175 KB | Blockether (in-house) |
| `com.blockether/vis-python-runtime` | `git:f5b3b76ecd73791e508950bfd9bb47fadd62f8ce` | MIT | source checkout | Blockether (in-house) |
