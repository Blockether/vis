...
| `com.blockether/svar` | `0.7.179` | Apache-2.0 | 829 KB | Blockether (in-house) |
| `com.blockether/vis-python-runtime` | `git:d5a3d1f63a350b9eb7117fc64908ee1445991070` | MIT | source checkout | Blockether (in-house) |
...
| Dependency | Version | License | Jar size | Ownership |
|---|---|---|---|---|
| `com.blockether/lanterna` | `3.1.5-vis.54` | LGPL-3.0 | 639 KB | Blockether (in-house) |
...
> **Copyleft: `com.blockether/lanterna` (`3.1.5-vis.54`) uses LGPL-3.0.** Review source, notice and relinking
