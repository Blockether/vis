...
| `com.blockether/svar` | `0.7.165` | Apache-2.0 | 617 KB | Blockether (in-house) |
| `com.blockether/tree-sitter-language-pack` | `1.12.3-blockether.39` | MIT | 175 KB | Blockether (in-house) |
| `com.blockether/vis-python-runtime` | `git:93682915550789ac98e4e12425d4e81afe50c09a` | MIT | source checkout | Blockether (in-house) |
