...
| `com.blockether/svar` | `0.7.178` | Apache-2.0 | 828 KB | Blockether (in-house) |
...
| Dependency | Version | License | Jar size | Ownership |
|---|---|---|---|---|
| `com.blockether/lanterna` | `3.1.5-vis.52` | LGPL-3.0 | 638 KB | Blockether (in-house) |
...
> **Copyleft: `com.blockether/lanterna` (`3.1.5-vis.52`) uses LGPL-3.0.** Review source, notice and relinking
