...
| `com.blockether/svar` | `0.7.161` | Apache-2.0 | 616 KB | Blockether (in-house) |
| `com.blockether/tree-sitter-language-pack` | `1.12.3-blockether.39` | MIT | 175 KB | Blockether (in-house) |
| `com.blockether/vis-python-runtime` | `git:23d20035e334e499fd3ea7273d74f3e6bc1fac0c` | MIT | source checkout | Blockether (in-house) |
