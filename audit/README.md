...
| Dependency | Version | License | Jar size | Ownership |
|---|---|---|---|---|
| `com.blockether/lanterna` | `3.1.5-vis.53` | LGPL-3.0 | 638 KB | Blockether (in-house) |
...
> **Copyleft: `com.blockether/lanterna` (`3.1.5-vis.53`) uses LGPL-3.0.** Review source, notice and relinking
