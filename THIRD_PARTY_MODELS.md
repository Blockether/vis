...
This file is generated: it is `resources/vis-models/manifest.edn` rendered. Edit the manifest, then run
`vis-agent speech models licenses --markdown > THIRD_PARTY_MODELS.md`. A test fails when the two disagree.
