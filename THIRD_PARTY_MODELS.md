...
- Upstream: <https://github.com/Blockether/vis/releases/tag/voice-assets-pack>
- Installs into: `~/.vis/models/voice-samples`
- Downloaded from, in order:
  - the Vis voice assets release, 1 MB - <https://github.com/Blockether/vis/releases/download/voice-assets-pack/voice-samples.tar.bz2>
