...
- Label each block in the page with its real component name (`SectionHeader`, `HeaderActions`, `NewSessionButton`, `KebabButton`). A proposal that cannot name its controls is not a proposal.
