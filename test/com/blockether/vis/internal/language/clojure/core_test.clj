(ns com.blockether.vis.internal.language.clojure.core-test
  ...
  (:require [clojure.java.io :as io]
            ...
            [com.blockether.vis.internal.language.clojure.core :as core]
...
(defdescribe manifest-initialization-test
             (it "names the language extension's explicit initializer"
                 (expect (some #{'com.blockether.vis.internal.language.clojure.core/register!}
...
(defn- with-repair
  ...
  (let [registered
        ...
        surface
        {:ext/name "fixture-clojure-repair"
...
(defdescribe
  ...
  (it
    ...
    (let [rp
          #'com.blockether.vis.internal.language.clojure.core/relativize-path
