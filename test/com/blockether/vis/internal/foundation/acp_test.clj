...
(defdescribe
  ...
  (it "classifies tool kinds, unknown tools included"
      ...
      (expect (= "execute" (acp/tool-kind "shell_run")))
      (expect (= "execute" (acp/tool-kind "shell_background")))
      (expect (= "execute" (acp/tool-kind "shell_logs")))
      (expect (= "move" (acp/tool-kind "move")))
      (expect (= "move" (acp/tool-kind "copy")))
      (expect (= "move" (acp/tool-kind "delete")))
      (expect (= "move" (acp/tool-kind "create_directory")))
      (expect (= "move" (acp/tool-kind "file_exists")))
