                 ...
                 (let [work (future (extension/invoke-symbol-wrapper ext entry [] {}))
                   ...
                   (try (is (some? view) (pr-str (deref work 0 ::running)))
                        ...
                        (let [result (deref work 10000 ::timeout)]
                          ...
                          (is (= {"id" "section-break" "type" "divider"}
                                 (last (get-in result ["view" "nodes"]))))
