...
class Base(object):
    ...
    async def fetch(
        self, url: str, timeout: float = 10.0, retries: int = 3, backoff: float = 0.5
    ) -> dict[str, object]:
        pass
...
def with_return_annotation(
    self,
) -> Set["Muy", "Long", "Annotation", "That", "Goes", "Beyond"]: ...
...
def defaults(a=-1, b=not True, c=(1, 2), *, d={}):
    pass
