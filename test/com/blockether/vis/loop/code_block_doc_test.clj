(ns com.blockether.vis.loop.code-block-doc-test
...
(defn- exec [environment expression doc]
  ...
  (let [execute-code-var (resolve 'com.blockether.vis.loop.runtime.conversation.environment.query.iteration.core/execute-code)]
