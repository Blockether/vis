...
(defdelegate db-list-orphaned-running-turns [db-info])
(defdelegate db-enqueue-turn! [db-info opts])
(defdelegate db-update-queued-turn! [db-info id request])
(defdelegate db-dequeue-turn! [db-info id])
(defdelegate db-list-queued-turns [db-info])
