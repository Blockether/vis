  ...
  (vis/extension
    {:ext/name "foundation-shim-httpx"
     ...
     [{:shim/name "httpx"
       :shim/imports ["httpx"]
       :shim/description
       (str "`httpx` subset wrapping requests: get/post, Client/AsyncClient, Response, "
            "raise_for_status. AsyncClient coroutines use synchronous I/O. "
            "No HTTP/2 or concurrent async I/O.")
