  ...
  (vis/symbol
    ...
    {:symbol 'shell
     ...
     (str
       ...
       "poll it with \"logs\" instead of blocking a run call. Reserve run for short commands. Run "
       "PROGRAMS here and leave filesystem work to native `grep`/`cat`/`fs` (search/read/list). "
       "\"send\" "
