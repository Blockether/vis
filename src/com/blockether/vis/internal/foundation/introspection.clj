...
(def ^:private INTROSPECTION_PROMPT
  (str
    ...
    "- Session history serves three needs: session diagnostics, evidence from a referenced conversation, and context the conversation lacks. A session or turn start, and `/reload`, keep the conversation intact: continue from it.\n"
