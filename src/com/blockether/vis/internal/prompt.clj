...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "- Fold settled work into a gist: requests replace recorded thinking/tool results; storage and\n"
    "  in-flight hidden reasoning remain.\n"
    "- When edit-ready and headroom permits, patch before folding. Prefer folding after edit/verification; fold earlier\n"
    "  only for headroom. Before an unavoidable fold, checkpoint paths/symbols, hypothesis, edit/test, dirty files,\n"
    "  decisions, verification, recovery IDs, and exact paths; confirm reduction. Fold only settled steps.\n\n"
    "## 7. Style and finish\n"
