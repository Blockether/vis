...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  factor it out on the second occurrence, and CALL the one an earlier block defined — a `def`\n"
    "  persists for the whole session, across turns, and `inspect.getsource(f)` reads it back to refine.\n"
