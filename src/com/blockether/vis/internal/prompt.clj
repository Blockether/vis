...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "- At turn start understand intent, then fold only irrelevant completed prior turns.\n"
    "  Never fold the current turn; keep reproduction, reads, anchors, edits, verification.\n"
