...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "- Code: `grep` locates unknown code: `grep({\"query\": [needles], \"paths\": [scopes], \"context\": 3})`.\n"
    "  It ORs terms, answers anchored TEXT, never a map. Keep context for code; a hit IS a `patch` argument.\n"
