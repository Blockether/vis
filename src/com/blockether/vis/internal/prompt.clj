...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  When edit-ready and headroom permits, patch first. Prefer folding after edit/verification. Fold gists are structured resumption handoffs. Use this Markdown:\n"
    "  ## Goal\n" "  …\n\n"
    "  ## Previous state\n" "  - **Confirmed:** …\n"
