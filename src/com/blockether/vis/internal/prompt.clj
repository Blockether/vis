...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "- Code: `grep` locates unknown code — `grep({\"query\": [needles], \"paths\": [scopes]})` ORs every\n"
    "  needle over every scope and answers anchored TEXT, never a map: a hit IS a `patch` argument.\n"
