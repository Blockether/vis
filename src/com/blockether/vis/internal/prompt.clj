...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "- Fold settled work into a gist: recorded thinking/tool results are replaced; storage and in-flight hidden reasoning remain.\n"
    "  When edit-ready and headroom permits, patch first. Prefer folding after edit/verification. Fold gists are structured resumption handoffs:\n"
    "  `Goal:` outcome; `Previous state:` confirmed work, edits, and checks; dead ends; worth exploring\n"
    "  (`tN/iN`, e.g. `t5/*`); `Hypothesis:` explanation; `Next:` edit/test/check. Before an unavoidable fold, checkpoint\n"
