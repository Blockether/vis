...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  The hunk / anchor helpers + cat's exact result shape are detailed once in the\n"
    "  editing-tools section below — use the smallest distinctive partial fragment.\n"
    ...
    "  answers your question, ACT — don't re-derive it.\n"
