...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  `patch`. Batch atomically; any write or `format` stales anchors—re-read before editing.\n"
    ...
    "- Fold completed prior-turn wire steps (spent edits/patches/reads first); keep a durable gist.\n"
