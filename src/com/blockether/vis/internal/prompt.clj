...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  results appear as a permanent `<results scope=\"tN/iM\">` user message in the\n"
    "  conversation (oldest first). Read them there; the bound\n"
    "  `context[\"session_trailer\"]` still carries the same data for code.\n\n"
