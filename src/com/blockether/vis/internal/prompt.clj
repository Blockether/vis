...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "- Fold settled search sweeps, raw tool output, dead ends, and superseded reads. Preserve only\n"
    "  decisions, durable findings, edits, verification, and identifiers needed to recover evidence.\n"
