...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  outlive the form goes through the verbs: task_set(\"key\", {\"status\":\n"
    "  \"doing\"}), fact_set(\"key\", {...}). A local binding is throwaway scratch —\n"
...
(def weak-model-operating-rules
  ...
  (str "Seven rules that override any temptation to do more:\n"
