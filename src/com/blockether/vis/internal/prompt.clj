...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  — use rg for files). Plain-text match over past iterations:\n"
    "    recall({\"match\": \"patch auth\", \"scope_after\": \"t2/i1\"})\n"
    "  → [{\"scope\": …, \"preview\": …, \"rank\": …}]; \"match\" is REQUIRED,\n"
    "  default limit 10. Summarized ranges stay searchable — a hit inside a fold\n"
