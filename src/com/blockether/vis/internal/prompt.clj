...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  `struct_index` every known file; read bodies in ONE call with `struct_nodes`\n"
    ...
    "- Fold obsolete settled work: `session_fold(target, gist)` — one broad `through`/range fold; omitting\n"
