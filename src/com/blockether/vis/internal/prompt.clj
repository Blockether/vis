...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  patch / write, run git with git_*, search with rg / search_*, and to run\n"
    "  a shell command / build / test use shell_run(...) when the shell tool is\n"
    "  enabled (off by default). NEVER reach for Python subprocess/os.system to\n"
    "  run a command — it fails; shell_run is the only sanctioned shell path.\n"
