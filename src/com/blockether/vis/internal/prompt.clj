...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  Never `time.sleep`, `asyncio.sleep`, or poll in Python: a condition ends a wait, not a clock.\n"
    ...
    "- Inspect first; answer pure knowledge straight from what you know.\n"
    ...
    "- Bugs: reproduce before editing; rerun the same check after the fix, or state why you cannot.\n"
