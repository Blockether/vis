...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "  Before re-running or scanning transcript, recover raw result by the `# saved:` coordinate\n"
    "  under it (`ntr[\"t5/i1/f2\"]`) or `ntr.describe()` labelled candidates: `r = ntr[\"t5/i1/f2\"]`\n"
