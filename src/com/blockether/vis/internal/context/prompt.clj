...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "- Fold obsolete settled work with `fold_session(key, gist)`; the key is a STRING: `\"-t2/i9\"` everything through it.\n"
    ...
    "- Make the next iteration only the call `fold_session(\"-tN/iK\", gist)` through the last completed research step;\n"
