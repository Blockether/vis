...
(def ^:private CORE_SYSTEM_PROMPT
  ...
  (str
    ...
    "- Cover changed behavior with tests; choose other checks by change type and project rules.\n"
    "  Python: `run_tests({\"language\": \"python\"})`; CLI: `vis-agent python -m pytest <paths>`.\n\n"
    "## 4. Edit + verify\n"
