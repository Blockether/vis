(ns com.blockether.vis.commandline.main
  "CLI dispatcher entry point.
   ...
   registers itself into `com.blockether.vis.commandline.base`'s global
  ...
  (:require [clojure.string :as str]
            ...
            [com.blockether.vis.extension :as extension]
...
;; facades. Add a third-party jar with its own `cmd/register-global!`
