(ns com.blockether.vis.loop.sci.shared
  "Shared helpers for the rlm.sci subsystem: SCI ns-map builder,
   ...
   No cross-tool deps (no conversation / git / restore / runtime). Safe to load
   first inside the sci/* bounded submodule."
  (:require
