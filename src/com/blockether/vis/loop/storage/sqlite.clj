(ns com.blockether.vis.loop.storage.sqlite
...
;; =============================================================================
;; FTS5-powered search (page nodes + TOC)
;; =============================================================================
...
(declare get-page-vitality compute-node-vitality recently-accessed-page-ids
  batch-cooccurrence-boosts record-document-access! propagate-activation!)
...
(defn propagate-activation!
  ...
  ([db-info page-id weight damping]
   (when (and (ds db-info) (pos? (double weight)))
     (try
       (let [cooc-neighbors (query! db-info
