...
(def workspace-abandon-lineage!  workspace/abandon-lineage!)
(def workspace-checkpoint?       workspace/checkpoint?)
(def workspace-checkpoint-create! workspace/checkpoint-create!)
(def workspace-checkpoint-diff   workspace/checkpoint-diff)
(def workspace-checkpoint-accept! workspace/checkpoint-accept!)
(def workspace-checkpoint-reject! workspace/checkpoint-reject!)
(def workspace-checkpoint-undo!  workspace/checkpoint-undo!)
(def workspace-checkpoint-redo!  workspace/checkpoint-redo!)
(def workspace-dag-details       workspace/dag-details)
