...
| Task 19 legacy prove/fulfill removal | NEXT / REQUIRED | Delete or hard-error stale `v/prove-gate!` / `v/fulfill-intent!` and underlying legacy write authority after callers migrate to audit/attestation surfaces and regression coverage is complete. |
