...
| Task 15 legacy removal | NEXT / REQUIRED | Delete stale legacy proof/prove/fulfill semantics after callers migrate to audit/attestation surfaces and regression coverage is complete. |
