...
| Task 21 legacy write-authority deletion | NEXT / REQUIRED | Delete or hard-error underlying legacy `db-prove-gate!` / `db-fulfill-intent!` write authority after remaining internal/foundation tests migrate to audit/attestation surfaces. |
