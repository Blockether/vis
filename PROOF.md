...
| Task 20 legacy write-authority deletion | NEXT / REQUIRED | Delete or hard-error underlying legacy `db-prove-gate!` / `db-fulfill-intent!` write authority after internal tests migrate to audit/attestation surfaces. |
