...
| Task 23 legacy write-authority deletion | NEXT / REQUIRED | Replace the explicit legacy audit-bypass fixture with direct legacy-row setup or a migration fixture, then delete/hard-error underlying legacy `db-prove-gate!` / `db-fulfill-intent!` write authority. |
