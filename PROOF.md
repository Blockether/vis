...
| Task 22 legacy write-authority deletion | NEXT / REQUIRED | Migrate remaining private proof-check diagnostic tests or move them to explicit legacy fixtures, then delete/hard-error underlying legacy `db-prove-gate!` / `db-fulfill-intent!` write authority. |
