...
| Task 24 legacy write-authority deletion | NEXT / REQUIRED | Migrate persistence core tests off legacy prove/fulfill writer APIs, then delete/hard-error underlying legacy `db-prove-gate!` / `db-fulfill-intent!` write authority. |
