...
[`extensions/vis-meta/resources/META-INF/vis-extension/vis.edn`](https://github.com/Blockether/vis/blob/main/extensions/vis-meta/resources/META-INF/vis-extension/vis.edn).
...
- From a Clojure REPL with vis-core on the classpath:
...
`vis-meta` is the agent's read-only introspection extension. Bound
